...
def calc_bonus(purchases: dict, members: dict, root_id: str):
    ...
    def diff_bonus(mid):
        ...
        info[mid]["bonus"] = rint(subtotal - child_sub) #自分が実際にもらえる差額ボーナス額
        return subtotal #このsubtotalは親へ返す値

    diff_bonus(root_id) #ルート会員を起点に差額計算をする
