...
def simulate(params: SimParams, members: dict) -> list:
    ...
    for month in range(1, params.month + 1):
        ...
        # 継続率ロジック
        count_child = next_counts(count_child, new_child, month, params.cont_rate, params.grace_month)
        count_grand = next_counts(count_grand, new_child, month, params.cont_rate, params.grace_month)
