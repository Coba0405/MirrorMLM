...
from backend.domain.constants import YEN_PER_PV, BV_PER_PV
...
def distribute():
    ...
    total_pv = int(amount_yen * YEN_PER_PV)total_pv = int(amount_yen * YEN_PER_PV)
    total_bv = int(total_bv * BV_PER_PV)
    total_bv = int(total_bv * BV_PER_PV)
