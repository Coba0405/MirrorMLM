...
def test_cont_rate():
    ...
    continuation_rate = params.count_child * params.cont_rate
    # continuation_rate(count_childが1人だったら0.9439)とcontinuation_rateと同一だったらTrueを返す
    assert continuation_rate == 0.9439
    continuation_rate = continuation_rate == continuation_rate * params.cont_rate
