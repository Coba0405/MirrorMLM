...
def test_cont_rate_decreases_children():
    ...
    members = {"A": {"parent": None, "join_month": 0},
               ...
               "B2": {"parent": "A", "join_month": 1},
               "B3": {"parent": "A", "join_month": 1},
               "B4": {"parent": "A", "join_month": 1},
               "B5": {"parent": "A", "join_month": 1},
               "B6": {"parent": "A", "join_month": 1},
               "B7": {"parent": "A", "join_month": 1},
               "B8": {"parent": "A", "join_month": 1},
               "B9": {"parent": "A", "join_month": 1},
               "B10": {"parent": "A", "join_month": 1},
    }
    params = SimParams(
        months = 6,
        self_monthly_yen = 30000,
